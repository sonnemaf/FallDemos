...
namespace FallDemos.Brushes {
    ...
    // Source: https://github.com/Microsoft/WindowsUIDevLabs/blob/master/SamplesCommon/SamplesCommon/CompositionShadow.xaml.cs 
    public sealed class ImageEffectBrush : XamlCompositionBrushBase {

        private LoadedImageSurface _surface;
        private CompositionSurfaceBrush _surfaceBrush;

        public static readonly DependencyProperty ImageUriStringProperty = DependencyProperty.Register(nameof(ImageUriString), typeof(string), typeof(ImageEffectBrush), new PropertyMetadata(String.Empty, new PropertyChangedCallback(OnImageUriStringChanged)));
        ...
        private static void OnImageUriStringChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            ...
            if (d is ImageEffectBrush brush && brush._surfaceBrush != null) {
